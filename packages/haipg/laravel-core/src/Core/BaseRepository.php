...
use HaiPG\LaravelCore\Exceptions\RepositoryException;
use HaiPG\LaravelCore\Traits\HasCriteria;
use HaiPG\LaravelCore\Traits\HasOrder;
use HaiPG\LaravelCore\Traits\HasScope;
